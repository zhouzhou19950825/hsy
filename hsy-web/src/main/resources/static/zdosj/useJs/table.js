...
function addAreaTableData() {
    ...
    // $("#addAreaTableDataButton").css('display', 'block');
    $("#right-table").append("<button class='btn btn-small' onclick=updateAreaTableDatas()>保存</button>");
...
function addChildrenHeadNode() {
    ...
    if (tdId === null || tdId === undefined || tdId === '') {
        ...
        if (parseInt(tdId) == -1) {
            ...
            var addedNode = getNodeById(tdId);
